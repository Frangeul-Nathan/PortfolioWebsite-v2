import FindYourMate from "../assets/images/Find Your Mate-min.png"
import Memory from "../assets/images/Memory JS-min.png"
import PiscineOpenData from "../assets/images/Piscine appli opendata-min.png"
import Bootstrap from "../assets/images/HTML et CSS (Bootstrap)-min.png"
import "../assets/css/partials/portfolio/_portfolio.scss"
        ...
        <div className="back-shapes">
          ...
          <div className="screenContainer">
            <div className="imageWrapper">
              <img src={FindYourMate} alt="FindYourMate" className="portfolio-image" />
              <h3>Full stack - Find Your Mate - Projet de Formation - Réseau Social de jeux vidéos </h3>
              <p>ReactJS - NodeJS - ExpressJS - MySQL - Sequelize - HTML - SCSS </p>
            </div>
            <div className="imageWrapper">
              <img src={Memory} alt="Memory" className="portfolio-image" />
              <h3>Front End - Jeu de mémoire </h3>
              <p>Javascript - HTML - CSS </p>
            </div>
            <div className="imageWrapper">
              <img src={PiscineOpenData} alt="" className="portfolio-image" />
              <h3>Front End - Application Piscine de Bordeaux </h3>
              <p>Javascript - HTML - CSS - API externe </p>
            </div>
            <div className="imageWrapper"> 
              <img src={Bootstrap} alt="" className="portfolio-image" />
              <h3>Front End - Espace Rénovation</h3>
              <p>Bootstrap - SCSS - HTML </p>
            </div>
          </div>
